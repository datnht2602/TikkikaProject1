                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="index.html" class="nav-item nav-link active">Trang Chu</a>
                            <a href="shop.html" class="nav-item nav-link">Quan Li Tin Tuc</a>
<!--                            <a href="detail.html" class="nav-item nav-link">Order</a>-->
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    <a href="cart.html" class="dropdown-item">Don Mua</a>
                                    <a href="checkout.html" class="dropdown-item">Don Ban</a>
                                </div>
                            </div>
